...
void Berzerker::skillOne()
{
    //Use character's first skill
}


void Berzerker::skillTwo()
{
    //Use character's second skkill
}


void Berzerker::takeDamage(int d)
{
    hp -= (d * dr);
    if(hp < 1)
    {
