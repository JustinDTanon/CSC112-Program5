...
void Assassin::skillOne()
{
    //Use character's first skill
}


void Assassin::skillTwo()
{
    //Use character's second skkill
}


void Assassin::takeDamage(int d)
{
    hp -= (d * dr);
    if(hp < 1)
    {
